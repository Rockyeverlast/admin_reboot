...
const CTASmall = ({elements, handleDragStart, handleDragOverr, handleDragEnd, index}) => {
  return (
    <section
    draggable
    ...
    >
        <img style={{ position:"absolute", top:0, right:0}} src={pattern} alt="" />

        <div className="col-6 ps-5 p-4">
        <h1 className='text-white mt-4'>Build Your Future</h1>
        <p className='text-white'>Partner with us for tailored software solutions. Your success is our priority</p>
        <button
